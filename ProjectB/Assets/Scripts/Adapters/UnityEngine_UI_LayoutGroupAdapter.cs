...
{   
    public class LayoutGroupAdapter : CrossBindingAdaptor
    {
        ...
        static CrossBindingMethodInfo mSetLayoutHorizontal_9 = new CrossBindingMethodInfo("SetLayoutHorizontal");
        static CrossBindingMethodInfo mSetLayoutVertical_10 = new CrossBindingMethodInfo("SetLayoutVertical");
        static CrossBindingMethodInfo mOnEnable_11 = new CrossBindingMethodInfo("OnEnable");
        static CrossBindingMethodInfo mOnDisable_12 = new CrossBindingMethodInfo("OnDisable");
        static CrossBindingMethodInfo mOnDidApplyAnimationProperties_13 = new CrossBindingMethodInfo("OnDidApplyAnimationProperties");
        static CrossBindingMethodInfo mOnRectTransformDimensionsChange_14 = new CrossBindingMethodInfo("OnRectTransformDimensionsChange");
        static CrossBindingMethodInfo mOnTransformChildrenChanged_15 = new CrossBindingMethodInfo("OnTransformChildrenChanged");
        static CrossBindingMethodInfo mOnValidate_16 = new CrossBindingMethodInfo("OnValidate");
        static CrossBindingMethodInfo mAwake_17 = new CrossBindingMethodInfo("Awake");
        static CrossBindingMethodInfo mStart_18 = new CrossBindingMethodInfo("Start");
        static CrossBindingMethodInfo mOnDestroy_19 = new CrossBindingMethodInfo("OnDestroy");
        static CrossBindingFunctionInfo<System.Boolean> mIsActive_20 = new CrossBindingFunctionInfo<System.Boolean>("IsActive");
        static CrossBindingMethodInfo mReset_21 = new CrossBindingMethodInfo("Reset");
        static CrossBindingMethodInfo mOnBeforeTransformParentChanged_22 = new CrossBindingMethodInfo("OnBeforeTransformParentChanged");
        static CrossBindingMethodInfo mOnTransformParentChanged_23 = new CrossBindingMethodInfo("OnTransformParentChanged");
        static CrossBindingMethodInfo mOnCanvasGroupChanged_24 = new CrossBindingMethodInfo("OnCanvasGroupChanged");
        static CrossBindingMethodInfo mOnCanvasHierarchyChanged_25 = new CrossBindingMethodInfo("OnCanvasHierarchyChanged");
        public override Type BaseCLRType
        {
            get
            {
                return typeof(UnityEngine.UI.LayoutGroup);
            }
        }
        ...
        public class Adapter : UnityEngine.UI.LayoutGroup, CrossBindingAdaptorType
        {
            ...
            {
                if (mCalculateLayoutInputHorizontal_0.CheckShouldInvokeBase(this.instance))
            ...
            {
                mSetLayoutHorizontal_9.Invoke(this.instance);
            }

            public override void SetLayoutVertical()
            {
                mSetLayoutVertical_10.Invoke(this.instance);
            }

            /*protected override void OnEnable()
            {
                if (mOnEnable_11.CheckShouldInvokeBase(this.instance))
                    base.OnEnable();
                else
                    mOnEnable_11.Invoke(this.instance);
            }

            protected override void OnDisable()
            {
                if (mOnDisable_12.CheckShouldInvokeBase(this.instance))
                    base.OnDisable();
                else
                    mOnDisable_12.Invoke(this.instance);
            }*/

/*            protected override void OnDidApplyAnimationProperties()
            {
                if (mOnDidApplyAnimationProperties_13.CheckShouldInvokeBase(this.instance))
                    base.OnDidApplyAnimationProperties();
                else
                    mOnDidApplyAnimationProperties_13.Invoke(this.instance);
            }*/

/*            protected override void OnRectTransformDimensionsChange()
            {
                if (mOnRectTransformDimensionsChange_14.CheckShouldInvokeBase(this.instance))
                    base.OnRectTransformDimensionsChange();
                else
                    mOnRectTransformDimensionsChange_14.Invoke(this.instance);
            }*/

/*            protected override void OnTransformChildrenChanged()
            {
                if (mOnTransformChildrenChanged_15.CheckShouldInvokeBase(this.instance))
                    base.OnTransformChildrenChanged();
                else
                    mOnTransformChildrenChanged_15.Invoke(this.instance);
            }

            protected override void OnValidate()
            {
                if (mOnValidate_16.CheckShouldInvokeBase(this.instance))
                    base.OnValidate();
                else
                    mOnValidate_16.Invoke(this.instance);
            }*/

/*            protected override void Awake()
            {
                if (mAwake_17.CheckShouldInvokeBase(this.instance))
                    base.Awake();
                else
                    mAwake_17.Invoke(this.instance);
            }

            protected override void Start()
            {
                if (mStart_18.CheckShouldInvokeBase(this.instance))
                    base.Start();
                else
                    mStart_18.Invoke(this.instance);
            }

            protected override void OnDestroy()
            {
                if (mOnDestroy_19.CheckShouldInvokeBase(this.instance))
                    base.OnDestroy();
                else
                    mOnDestroy_19.Invoke(this.instance);
            }*/

            public override System.Boolean IsActive()
            {
                if (mIsActive_20.CheckShouldInvokeBase(this.instance))
                    return base.IsActive();
                else
                    return mIsActive_20.Invoke(this.instance);
            }

/*            protected override void Reset()
            {
                if (mReset_21.CheckShouldInvokeBase(this.instance))
                    base.Reset();
                else
                    mReset_21.Invoke(this.instance);
            }*/

/*            protected override void OnBeforeTransformParentChanged()
            {
                if (mOnBeforeTransformParentChanged_22.CheckShouldInvokeBase(this.instance))
                    base.OnBeforeTransformParentChanged();
                else
                    mOnBeforeTransformParentChanged_22.Invoke(this.instance);
            }*/

/*            protected override void OnTransformParentChanged()
            {
                if (mOnTransformParentChanged_23.CheckShouldInvokeBase(this.instance))
                    base.OnTransformParentChanged();
                else
                    mOnTransformParentChanged_23.Invoke(this.instance);
            }*/

/*            protected override void OnCanvasGroupChanged()
            {
                if (mOnCanvasGroupChanged_24.CheckShouldInvokeBase(this.instance))
                    base.OnCanvasGroupChanged();
                else
                    mOnCanvasGroupChanged_24.Invoke(this.instance);
            }*/

/*            protected override void OnCanvasHierarchyChanged()
            {
                if (mOnCanvasHierarchyChanged_25.CheckShouldInvokeBase(this.instance))
                    base.OnCanvasHierarchyChanged();
                else
                    mOnCanvasHierarchyChanged_25.Invoke(this.instance);
            }*/
            ...
            get
            {
                if (mget_minWidth_2.CheckShouldInvokeBase(this.instance))
            ...
            get
            {
                if (mget_preferredWidth_3.CheckShouldInvokeBase(this.instance))
            ...
            get
            {
                if (mget_flexibleWidth_4.CheckShouldInvokeBase(this.instance))
            ...
            get
            {
                if (mget_minHeight_5.CheckShouldInvokeBase(this.instance))
            ...
            get
            {
                if (mget_preferredHeight_6.CheckShouldInvokeBase(this.instance))
            ...
            get
            {
                if (mget_flexibleHeight_7.CheckShouldInvokeBase(this.instance))
            ...
            get
            {
                if (mget_layoutPriority_8.CheckShouldInvokeBase(this.instance))
