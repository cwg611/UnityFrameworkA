...
[CustomEditor(typeof(TextAdapter.Adapter), true)]
public class TextAdapterEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        ProjectAdapter.TextAdapter.Adapter clr = target as ProjectAdapter.TextAdapter.Adapter;
