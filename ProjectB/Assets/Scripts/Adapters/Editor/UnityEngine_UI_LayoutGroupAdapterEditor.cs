...
[CustomEditor(typeof(LayoutGroupAdapter.Adapter), true)]
public class LayoutGroupAdapterEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        ProjectAdapter.LayoutGroupAdapter.Adapter clr = target as ProjectAdapter.LayoutGroupAdapter.Adapter;
