...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_PointerEventData_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_enterEventCamera_3);
            args = new Type[]{typeof(UnityEngine.GameObject)};
            method = type.GetMethod("set_pointerDrag", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_pointerDrag_4);
            args = new Type[]{typeof(UnityEngine.Vector2)};
            method = type.GetMethod("set_pressPosition", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_pressPosition_5);
        ...
        static StackObject* get_enterEventCamera_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* set_pointerDrag_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* set_pressPosition_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
