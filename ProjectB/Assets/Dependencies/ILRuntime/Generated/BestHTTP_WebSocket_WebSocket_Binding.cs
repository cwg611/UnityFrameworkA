...
namespace ILRuntime.Runtime.Generated
{
    unsafe class BestHTTP_WebSocket_WebSocket_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            field = type.GetField("OnBinary", flag);
            app.RegisterCLRFieldGetter(field, get_OnBinary_2);
            app.RegisterCLRFieldSetter(field, set_OnBinary_2);
            app.RegisterCLRFieldBinding(field, CopyToStack_OnBinary_2, AssignFromStack_OnBinary_2);
            ...
            app.RegisterCLRFieldGetter(field, get_OnError_4);
            app.RegisterCLRFieldSetter(field, set_OnError_4);
            app.RegisterCLRFieldBinding(field, CopyToStack_OnError_4, AssignFromStack_OnError_4);
        ...
        static StackObject* Open_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            BestHTTP.WebSocket.WebSocket instance_of_this_method = (BestHTTP.WebSocket.WebSocket)typeof(BestHTTP.WebSocket.WebSocket).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            BestHTTP.WebSocket.OnWebSocketOpenDelegate @OnOpen = (BestHTTP.WebSocket.OnWebSocketOpenDelegate)typeof(BestHTTP.WebSocket.OnWebSocketOpenDelegate).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            BestHTTP.WebSocket.OnWebSocketMessageDelegate @OnMessage = (BestHTTP.WebSocket.OnWebSocketMessageDelegate)typeof(BestHTTP.WebSocket.OnWebSocketMessageDelegate).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ((BestHTTP.WebSocket.WebSocket)o).OnMessage = @OnMessage;
            return ptr_of_this_method;
        }

        static object get_OnBinary_2(ref object o)
        {
            return ((BestHTTP.WebSocket.WebSocket)o).OnBinary;
        }

        static StackObject* CopyToStack_OnBinary_2(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((BestHTTP.WebSocket.WebSocket)o).OnBinary;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_OnBinary_2(ref object o, object v)
        {
            ((BestHTTP.WebSocket.WebSocket)o).OnBinary = (BestHTTP.WebSocket.OnWebSocketBinaryDelegate)v;
        }

        static StackObject* AssignFromStack_OnBinary_2(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            BestHTTP.WebSocket.OnWebSocketBinaryDelegate @OnBinary = (BestHTTP.WebSocket.OnWebSocketBinaryDelegate)typeof(BestHTTP.WebSocket.OnWebSocketBinaryDelegate).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ((BestHTTP.WebSocket.WebSocket)o).OnBinary = @OnBinary;
            return ptr_of_this_method;
        }
        ...
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            BestHTTP.WebSocket.OnWebSocketClosedDelegate @OnClosed = (BestHTTP.WebSocket.OnWebSocketClosedDelegate)typeof(BestHTTP.WebSocket.OnWebSocketClosedDelegate).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ((BestHTTP.WebSocket.WebSocket)o).OnClosed = @OnClosed;
            return ptr_of_this_method;
        }

        static object get_OnError_4(ref object o)
        {
            return ((BestHTTP.WebSocket.WebSocket)o).OnError;
        }

        static StackObject* CopyToStack_OnError_4(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((BestHTTP.WebSocket.WebSocket)o).OnError;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_OnError_4(ref object o, object v)
        {
            ((BestHTTP.WebSocket.WebSocket)o).OnError = (BestHTTP.WebSocket.OnWebSocketErrorDelegate)v;
        }

        static StackObject* AssignFromStack_OnError_4(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            BestHTTP.WebSocket.OnWebSocketErrorDelegate @OnError = (BestHTTP.WebSocket.OnWebSocketErrorDelegate)typeof(BestHTTP.WebSocket.OnWebSocketErrorDelegate).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
