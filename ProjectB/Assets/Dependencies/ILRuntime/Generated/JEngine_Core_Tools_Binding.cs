...
namespace ILRuntime.Runtime.Generated
{
    unsafe class JEngine_Core_Tools_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetHotComponent_0);


        }


        static StackObject* GetHotComponent_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
