...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_EventSystem_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("IsPointerOverGameObject", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, IsPointerOverGameObject_3);
        ...
        static StackObject* IsPointerOverGameObject_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
