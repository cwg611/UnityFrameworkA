...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Input_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetKeyDown_3);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("GetMouseButtonUp", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetMouseButtonUp_4);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("GetAxis", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetAxis_5);
            args = new Type[]{};
            method = type.GetMethod("get_touchCount", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_touchCount_6);
            args = new Type[]{typeof(System.Int32)};
        ...
        static StackObject* GetKeyDown_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* GetMouseButtonUp_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* GetAxis_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_touchCount_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
